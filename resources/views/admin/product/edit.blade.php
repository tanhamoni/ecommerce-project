                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary card-outline mb-4">
                            ...
                            <!--end::Header-->
                            <!--begin::Form-->
                            <form action="{{ url('/owner/product-update/'.$product->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Body-->
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="mb-3" id="color_fields">
                                                ...
                                                @if ($product->color->isNotEmpty())
                                                    @foreach ($product->color as $singleColor)
                                                        <input type="text" class="form-control mb-2" name="color_name[]" value="{{$singleColor->color_name}}" placeholder="Color Name" id="color_name"/>
                                                    @endforeach
                                                @else
                                            ...
                                            <div class="mb-3" id="size_fields">
                                                ...
                                                @if ($product->size->isNotEmpty())
                                                    @foreach ($product->size as $singleSize)
                                                        <input type="text" class="form-control mb-2" name="size_name[]" value="{{$singleSize->size_name}}" placeholder="Size Name" id="size_name"/>
                                                    @endforeach
                                                @else
                                        ...
                                        <div class="col-md-4 col-sm-6 col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" name="buying_price"
                                                    id="buying_price" value="{{ $product->buying_price }}" />
                                                @error('buying_price')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" name="regular_price"
                                                    id="regular_price" value="{{ $product->regular_price }}" />
                                                @error('regular_price')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" name="discount_price"
                                                    id="discount_price" value="{{ $product->discount_price }}" />
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="summernote_two" class="form-label">Product Policy
                                                    (Optional)</label>
                                                <textarea name="product_policy" class="form-control" id="summernote_two">{{ $product->product_policy }}</textarea>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-12">
                                            <div class="input-group mb-3">
                                              ...
                                              @foreach ($product->galleryImage as $singleImage)
                                                <img src="{{$singleImage->image}}" height="100" width="100" class="mb-3">
                                            @endforeach
