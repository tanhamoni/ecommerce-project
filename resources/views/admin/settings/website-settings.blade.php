                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $websiteSettings->phone ?? '' }}" name="phone" id="phone"
                                            required />
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control"
                                            value="{{ $websiteSettings->email ?? '' }}" name="email" id="email"
                                            required />
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $websiteSettings->facebook ?? '' }}" name="facebook" id="facebook" />
                                    </div>

                                    <div class="mb-3">
                                        <label for="twitter" class="form-label">Twitter Link (Optional)</label>
                                        <input type="text" class="form-control"
                                            value="{{ $websiteSettings->twitter ?? '' }}" name="twitter" id="twitter" />
                                    </div>

                                    <div class="mb-3">
                                        <label for="instagram" class="form-label">Instagram Link (Optional)</label>
                                        <input type="text" class="form-control"
                                            value="{{ $websiteSettings->instagram ?? '' }}" name="instagram"
                                            id="instagram" />
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $websiteSettings->youtube ?? '' }}" name="youtube" id="youtube" />
                                    </div>
                                    ...
                                    @if (!empty($websiteSettings->logo))
                                        <div class="mb-3">
                                            <img src="{{ $websiteSettings->logo }}" height="70" width="150"
                                                alt="Logo Preview" style="object-fit: contain;">
                                        </div>
                                    @endif
                                    ...
                                    @if (!empty($websiteSettings->hero_image))
                                        <div class="mb-3">
                                            <img src="{{ $websiteSettings->hero_image }}" height="200" width="100%"
                                                alt="Hero Image Preview" style="object-fit: cover; max-width: 600px;">
                                        </div>
                                    @endif
                                </div>
                                <!--end::Body-->
